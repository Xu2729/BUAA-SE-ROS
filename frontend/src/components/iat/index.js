...
const transWorker = new Worker('static/js/transcode.worker.js')
//APPID，APISecret，APIKey在控制台-我的应用-语音听写（流式版）页面获取
const APPID = '8a50278a'
const API_SECRET = 'MjIwODUyOGQ2YTE0MWU1ZmFkZDkzNTQz'
const API_KEY = '1e4552be3c7a392e7f92230888e5d5d9'
